...
public class Philosopher extends BaseThread {
    ...
    public void eat() {
        try {
            ...
            Thread.yield();
            System.out.println("Philosopher: " + getTID() + " are done eating");
            // ...
    ...
    public void think() {
        ...
        try {
            ...
            sleep((long) (Math.random() * TIME_TO_WASTE));
            Thread.yield();
            System.out.println("Philosopher: " + getTID() + " are done thinking");
            // ...
        } catch (InterruptedException e) {
    ...
    public void talk() {
        ...
        saySomething();
        Thread.yield();
        System.out.println("Philosopher: " + getTID() + " are done talking");
        // ...
    }
